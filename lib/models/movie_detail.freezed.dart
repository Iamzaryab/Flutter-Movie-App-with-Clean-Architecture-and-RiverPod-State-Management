...
class _$MovieDetailImpl extends _MovieDetail {
  ...
  @override
  String toString() {
    return 'MovieDetail(isarId: $isarId, id: $id, voteCount: $voteCount, runtime: $runtime, revenue: $revenue, voteAverage: $voteAverage, popularity: $popularity, adult: $adult, video: $video, backdropPath: $backdropPath, status: $status, tagline: $tagline, title: $title, releaseDate: $releaseDate, posterPath: $posterPath, imdbId: $imdbId, originalLanguage: $originalLanguage, homepage: $homepage, originalTitle: $originalTitle, overview: $overview, genres: $genres)';
  }
...
abstract class _MovieDetail extends MovieDetail {
  const factory _MovieDetail(
      ...
      @JsonKey(name: 'genres') final List<Genre> genres}) = _$MovieDetailImpl;
