...
void _notificationModelSerialize(
  ...
  writer.writeBool(offsets[1], object.positive);
...
NotificationModel _notificationModelDeserialize(
  ...
  final object = NotificationModel(
    ...
    positive: reader.readBool(offsets[1]),
...
extension NotificationModelQuerySortBy
  ...
  QueryBuilder<NotificationModel, NotificationModel, QAfterSortBy>
      sortByPositive() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'positive', Sort.asc);
    });
  }
  ...
  QueryBuilder<NotificationModel, NotificationModel, QAfterSortBy>
      sortByPositiveDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'positive', Sort.desc);
    });
  }
...
extension NotificationModelQueryWhereDistinct
  ...
  QueryBuilder<NotificationModel, NotificationModel, QDistinct>
      distinctByPositive() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'positive');
    });
  }
...
extension NotificationModelQueryProperty
  ...
  QueryBuilder<NotificationModel, bool, QQueryOperations> positiveProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'positive');
    });
  }
